...
add1_lab = mkgrid(0, 0, ttk.Label(root, text="addend 1",anchor='e'))         
add2_lab = mkgrid(1, 0, ttk.Label(root, text="addend 2",anchor='e'))                   
...
add_but = mkgrid(1, 2, ttk.Button(root, text="Add them",command=add_it))           
